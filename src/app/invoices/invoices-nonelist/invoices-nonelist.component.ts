...
export class InvoiceNotDeliveredListComponent implements OnInit {
  ...
  getInvoices(page, datefrom, dateto, comcode, level, period) {
  ...
  // 배송정보 다운로드
  download(datefrom, dateto, comcode, level, period) {
